                                                ...
                                                <div className="card success-card">
                                                    <div className="card-body">
                                                        <div className="success-cont">
                                                            ...
                                                            <p>Nếu bạn nhấn "Xác nhận" thì người giao hàng này được xóa, nếu bạn muốn thêm lại người giao hàng thì vào phần "Thêm nngười giao hàng" để thêm người giao hàng mới.</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                {/* Success Card */}
